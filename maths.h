...
static inline void matrix4x4f_copy(matrix4x4f s, matrix4x4f d)
{
	memcpy(d, s, sizeof(matrix4x4f));
}
static inline void matrix4x4f_translate(float x, float y, float z, float matrix[16])
{
...
static inline void matrix4x4f_scale(float x, float y, float z, float matrix[16])
{
	matrix4x4f_copy(identity_4x4f,matrix);
	matrix[0] = x;
	matrix[5] = y;
...
static inline void matrix4x4f_rotate(float a, float x, float y, float z, float matrix[16])
{
	float c, s, t;
...
static inline void matrix4x4f_mult_matrix4x4f(const matrix4x4f m1, const matrix4x4f m2, matrix4x4f r)
{
	matrix4x4f t;
	int i, j;
