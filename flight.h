...
"                       Keyboard commands",
"                       -------- --------",
"  x/w - zoom in/out (tower view)    a/s - decrease/increase thrust",
"  d   - toggle tower/plane view     f/F - increase/decrease flaps",
"  l   - toggle landing gear         c/C - increase/decrease spoilers",
"  n   - toggle day/night time       T   - toggle threat envelopes",
"  X   - free camera view            W   - wingman view",
"  D   - cycle tower viewpoints      h   - pause + help overlay",
"  ESC - return to title screen      r/R/u - abort current flight",
"  F1  - toggle fog                  F2/F3 - toggle light/textures",
"  F11 - toggle fullscreen           arrows - pan pilot / move tower/free cam",
""
};

static char *plane_menu[27] = {
...
"  7   Balloon         900        0         0   900    34  +2g  -1g      0",
"  8   Blimp         1,000        0       300   157    28  +5g  -3g      0",
"  9   Helicopter    2,500        0     1,200   220    35  +4g  -2g      0",
"  ",
"  ",
...
void handle_key(char k, struct gameState *gs, Plane pp);
...
void common_plane_init(struct gameState* gs, Plane pp);
#ifndef FALSE
#define FALSE 0
#endif
